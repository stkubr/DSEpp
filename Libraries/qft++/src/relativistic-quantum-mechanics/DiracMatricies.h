...
#define i_UNIT complex<double>(0.0,1.0)
...
/*
    this->Element(0,2).Element(0) = 1.0;
    this->Element(0,2).Element(3) = complex<double>(0.,-1.)*1.0;
    this->Element(0,3).Element(1) = complex<double>(0.,-1.)*1.0;
    this->Element(0,3).Element(2) = complex<double>(0.,-1.)*complex<double>(0.,-1.);
    this->Element(1,3).Element(0) = 1.0;
    this->Element(1,2).Element(1) = complex<double>(0.,-1.)*1.0;
    this->Element(1,2).Element(2) = complex<double>(0.,-1.)*complex<double>(0.,1.);
    this->Element(1,3).Element(3) = -1.0*complex<double>(0.,-1.);
    this->Element(2,0).Element(3) = -1.0*complex<double>(0.,-1.);
    this->Element(2,1).Element(1) = -1.0*complex<double>(0.,-1.);
    this->Element(2,1).Element(2) = complex<double>(0.,1.)*complex<double>(0.,-1.);
    this->Element(2,0).Element(0) = 1.0;
    this->Element(3,0).Element(1) = -1.0*complex<double>(0.,-1.);
    this->Element(3,0).Element(2) = complex<double>(0.,-1.)*complex<double>(0.,-1.);
    this->Element(3,1).Element(3) = 1.0*complex<double>(0.,-1.);
    this->Element(3,1).Element(0) = 1.0;
*/

	// gamma 1
	this->Element(0,3).Element(0) = 1.0*i_UNIT;
	this->Element(1,2).Element(0) = 1.0*i_UNIT;
	this->Element(2,1).Element(0) = -1.0*i_UNIT;
	this->Element(3,0).Element(0) = -1.0*i_UNIT;
	...
	//gamma 3 
	this->Element(0,2).Element(2) = 1.0*i_UNIT;
	this->Element(1,3).Element(2) = -1.0*i_UNIT;
	this->Element(2,0).Element(2) = -1.0*i_UNIT;
	this->Element(3,1).Element(2) = 1.0*i_UNIT;
