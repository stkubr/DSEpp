/*
 * TwoLoopIntegrator.hpp
 *
 *  Created on: Feb 12, 2014
 *      Author: stkubr
 */

#ifndef TWOLOOPINTEGRATOR_HPP_
#define TWOLOOPINTEGRATOR_HPP_

class C_TwoLoopIntegrator{
	public:
	...
	C_Integrator_Line<t_cmplxMatrix,C_TwoLoopIntegrator,double> * Integ_radial_1;
	C_Integrator_Line<t_cmplxMatrix,C_TwoLoopIntegrator,double> * Integ_angle_cheb_1;
	C_Integrator_Line<t_cmplxMatrix,C_TwoLoopIntegrator,double> * Integ_angle_Y_1;

	C_Integrator_Line<t_cmplxMatrix,C_TwoLoopIntegrator,double> * Integ_radial_2;
	C_Integrator_Line<t_cmplxMatrix,C_TwoLoopIntegrator,double> * Integ_angle_cheb_2;
	C_Integrator_Line<t_cmplxMatrix,C_TwoLoopIntegrator,double> * Integ_angle_Y_2;
	C_Integrator_Line<t_cmplxMatrix,C_TwoLoopIntegrator,double> * Integ_angle_Phi_2;
	...
	t_cmplxMatrix quad7d(){
		...
		k_col_1=0;
		Int_counter_1=0;
		return Integ_radial_1->getResult(&C_TwoLoopIntegrator::f1,this);
	}
	t_cmplxMatrix f1(double k){
		k_col_1++;
		integrand_args[0]=(k);
		return Integ_angle_cheb_1->getResult(&C_TwoLoopIntegrator::f2,this);
	}
	t_cmplxMatrix f2(double z){
		integrand_args[1]=z;
		return Integ_angle_Y_1->getResult(&C_TwoLoopIntegrator::f3,this);
	}
	...
	t_cmplxMatrix quad4d(){
		...
		Int_counter_2=0;
		Int_counter_1++;
		return Integ_radial_2->getResult(&C_TwoLoopIntegrator::s1,this);
	}
	t_cmplxMatrix s1(double k){
		k_col_2++;
		integrand_args[3]=(k);
		return Integ_angle_cheb_2->getResult(&C_TwoLoopIntegrator::s2,this);
	}
	t_cmplxMatrix s2(double z){
		integrand_args[4]=z;
		return Integ_angle_Y_2->getResult(&C_TwoLoopIntegrator::s3,this);
	}
	t_cmplxMatrix s3(double y){
		integrand_args[5]=y;
		return Integ_angle_Phi_2->getResult(&C_TwoLoopIntegrator::s4,this);
	}
...
{//start parallel region
		C_TwoLoopIntegrator * Parallel_Copy;
	...
	virtual C_TwoLoopIntegrator * MakeCopy()
	{
