...
namespace Integration {
    ...
    template<typename T_out, typename T_contour, typename T_in>
    class C_Integrator_Path {
    protected:
        int NumAmps;
    ...
    public:
        static C_Integrator_Path *createIntegrator(int _NumPoints,
                                                   std::function<T_in(T_in, T_in)> *_IntegrationWeightFunction) {
            C_Integrator_Path *p;
