...
/**
 * \brief The Rainbow-Ladder + Pion exchange scattering Kernel
 *
 * The single gluon exchange + pion cloud effect.
 * setMediators() sets the gluon polarization tensor with effective gluon dressing function +
 * pion propagator + pion-quark vertex by SetPSMatrix().
*/
