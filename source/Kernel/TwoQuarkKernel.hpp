...
/**
 * \brief The two-quark abstract scattering Kernel
 *
 * The base class for all two-quark kernels. The mediators (particle propagating inside the kernel)
 * are to be specified in derived classes
*/
