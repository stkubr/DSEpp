...
// Set Cauchy contour
//----------------------------------------------------------------------
	void C_Quark::setContourAndGrid()
	{
...
//----------------------------------------------------------------------
	t_cmplx C_Quark::InitStepA (t_cmplx z)
	{
		return  1.0 + exp(-z*z);
	}
	t_cmplx C_Quark::InitStepB (t_cmplx z)
	{
		return 1.0*exp(-z*z);
	}
...
//----------------------------------------------------------------------
	t_cmplxMatrix C_Quark::Integrand_analitic (t_cmplxArray1D values)
	{
		t_cmplx y,z;
		y=values[0];
		z=values[1];
...
//----------------------------------------------------------------------
	t_cmplxMatrix C_Quark::Integrand_numerical (t_cmplxArray1D values)
	{
...
//----------------------------------------------------------------------
	...
	void C_Quark::SetQuarkonPath(std::vector<t_cmplxMatrix> (*Amplitudes),t_cmplxArray1D (*Path))
	{
		std::cout << std::endl;
